 ...
 * @for(任务组的核心适配器)
 */
public class MissionGroupRealAdapter extends BaseExpandableListAdapter{
	private List<List<MissionsForGroup>> data;//作为任务组的资源list。第一层是星期数，第二层是星期几。
	...
	private MissionsForGroup missions;
	private LinearLayout layout_missionGroup;
	
	//-------------------输入的变量----------------------------------


	public MissionGroupRealAdapter(List<List<MissionsForGroup>> data2,
	...
	public View getChildView(int groupPosition, int childPosition,  
	    ...
	    textView_comment=(TextView) convertView.findViewById(R.id.TextView_childcomment);
		textView_content=(TextView) convertView.findViewById(R.id.TextView_childcontent);
		layout_missionGroup=(LinearLayout) convertView.findViewById(R.id.LinearLayout_missiongroup_newChild);
		textView_comment.setText(missions.getComment());
		textView_content.setText(missions.getContent());
		return convertView;
	}
